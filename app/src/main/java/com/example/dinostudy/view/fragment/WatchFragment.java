...
import com.example.dinostudy.view.activity.LoginActivity;
...
//        String curDate = getArguments().getString("curdate");
        ...
        String subject = "subject" + n;
        String time = "time" + n;

        watchViewModel.readWatch(new ReadWatchData(username, curDate, subject, time));
        watchViewModel.readResult.observe(getViewLifecycleOwner(), res -> {
            System.out.println(res.getSubject());
            System.out.println(res.getTime());

            int readCode = res.getCode();
                ...
                */
                ...
                binding_plus_subject.btnSubjectInsert.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        watchViewModel.addWatch(new AddWatchData(username, curDate, subject, time, n.get()));
